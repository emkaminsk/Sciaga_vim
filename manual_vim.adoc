...
Vi powstał jako 'visual interface' do innego edytora _ex_. _Ex_ był edytorem tekstu na teleksie, narzędziu do przesyłania tekstu. Stąd tryb _ex_ w vi i stąd pochodzą polecenia ':', '$','^', '%', oznaczanie zakresu przez 'a,b', 'g', 's', 'm' i inne.
